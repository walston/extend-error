...
describe('inheritance', function() {
  it('should maintain prototype hierarchy with one level', function() {
    ...
    assert.ok(
      err instanceof errors.ClientError,
      'ClientError is not an instance of ClientError'
    );
  ...
  it('should maintain prototype hierarchy with two levels', function() {
    ...
    assert.ok(
      notfound instanceof errors.HttpNotFound,
      'HttpNotFound is not an instance of HttpNotFound'
    );
    assert.ok(
      notfound instanceof errors.ClientError,
      'HttpNotFound is not an instance of ClientError'
    );
    assert.ok(
      notfound instanceof Error,
      'HttpNotFound is not an instance of Error'
    );
  });
});
